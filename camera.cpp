...
// マクロ定義
//*****************************************************************************
#define	CAM_POS_V_X		(500.0f)					// カメラの視点初期位置(X座標)
#define	CAM_POS_V_Y		(500.0f)				// カメラの視点初期位置(Y座標)
#define	CAM_POS_V_Z		(-950.0f)				// カメラの視点初期位置(Z座標)
#define	CAM_POS_R_X		(500.0f)					// カメラの注視点初期位置(X座標)
...
void Camera_Initialize(void)
{
	...
	oldpos = D3DXVECTOR3(500, 100, -600);
